...
const Navbar = () => {
    return (
        <nav id="sidebarMenu" className="sidenav">
            <a className="nav-link active" aria-current="page" href="#OngoingOps">
                <span className="feather-users"></span> Ongoing Ops
            </a>
            <a className="nav-link" href="#UpcomOps">
                <span className="feather-layers"></span> Request Ops
            </a>
            <a className="nav-link" href="#ComplOps">
                <span className="feather-file"></span> Complete Ops
            </a>
            <a className="nav-link" href="#TechOpsStats">
